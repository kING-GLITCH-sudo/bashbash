...
const css = `
  ...
  .user-bar { display: flex; width: 100%; height: 70px; align-items: center; background:rgb(255, 255, 255); color: #fff; font-size: 24px; position: absolute; z-index: 99999; top: 0; }
